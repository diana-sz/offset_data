The script `get_R_sector.R` extracts protein mass fractions for the R sector of E. coli from published proteomics datasets and combines them with growth-rate data.
...
The resulting R-sector estimates are saved as R_data.csv.