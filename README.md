...
The resulting T-sector estimates are saved as T_protein_data.csv.
...
The resulting R-sector estimates are saved as Rb_protein_data.csv.

The script `Analysis.R` performs linear regression of the Rb_protein_data.csv and T_protein_data.csv (the mass fraction of Rb and T proteins vs. growth rate).